...
for k = 1:maxIt   
    ...
    NumVcycle = 0;%info.itStep;
    NumVcycle_ite = [NumVcycle];
    
    while abs(residualErr4(ite))>tol*residualErr4(1) && ite < maxTPDIt
...
%         unew_tmp2 = unew_tmp2(isFreeEdge);
        ...
        unew_tmp2 = G*unew_tmp2; %DMinve*G*unew_tmp2;
        ...
        residualErr4(ite) = norm(resi)/sqrt(length(resi));
